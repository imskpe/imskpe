...
static double sampled_source PROTO((klatt_global_ptr));
static double impulsive_source PROTO((klatt_global_ptr));
static double natural_source PROTO((klatt_global_ptr));
static void pitch_synch_par_reset PROTO((klatt_global_ptr,klatt_frame_ptr)); 
static double gen_noise PROTO((double,klatt_global_ptr));
static double DBtoLIN PROTO((long));
static void frame_init PROTO((klatt_global_ptr,klatt_frame_ptr)); 
static double resonator PROTO((resonator_ptr, double));
static double antiresonator PROTO((resonator_ptr, double));
...
static double resonator(r, input)
...
static double antiresonator(r, input)
...
static double sampled_source(globals)
...
static double impulsive_source(globals) 
...
static double natural_source(globals) 
...
static double gen_noise(noise,globals) 
